...
namespace Minaalfy\LaravelDocker\Console;

use Illuminate\Console\Command;
use Symfony\Component\Console\Attribute\AsCommand;

#[AsCommand(name: 'docker:install')]
class InstallCommand extends Command
{
    ...
    protected $signature = 'docker:install
                ...
                {--php=8.2 : The PHP version that should be used}';
     ...
     * @var string
     */
    protected $description = 'Install Laravel default Docker Compose file';
